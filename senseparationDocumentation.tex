...
\begin{table*}[ht]
	...
	\newcolumntype{R}{>{\raggedleft\arraybackslash\currentrowstyle}X}%
	\newcolumntype{L}{>{\raggedright\arraybackslash\currentrowstyle}X}%
	\newcolumntype{C}{>{\centering\arraybackslash\currentrowstyle}X}%

	
	\begin{minipage}{\linewidth}
		\begin{tabularx}{\linewidth}{| +>{\itshape}L L L L L L L L >{\ttfamily}L | L}
			\hline
			...
			\hline
			\hline
			Activity Idicator   & nominal       & 0 (end),\newline1 (begin)   &                             &                          &                      & i     & /cave_person/activity   & TCP \\ 
			\hline
			Position	            & real vector   & unbounded                   & center of DARK ROOM floor   & right-handed Cartesian   & centimeters          & ff    & /cave_person/position   & UDP \\ 
			\hline
			 Velocity           & real          & [0, 1]	                      &                             &                          &                      & f     & /cave_person/velocity   & UDP\\ 
			\hline
			 Touch Start/End	    & nominal       &                             &                             & ---                      & 0 (end), 1 (begin)   & i     & /cave_person/touch      & TCP \\ 
			\hline
			 Touch              & real vector   &                             &                             &                          &                      & fff   & /cave_person/touching   & UDP \\ 
			\hline
			 Hit	                & real vector   &                             &                             &                          &                      & fff   & /cave_person/hit        & TCP \\ 
			\hline
			 Bumb               & real vector   &                             &                             &                          &                      & ff    & /cave_person/bump       & TCP \\ 
			\hline
		\end{tabularx}
	\end{minipage}
	\caption{Complete protocol definition}
\end{table*}
